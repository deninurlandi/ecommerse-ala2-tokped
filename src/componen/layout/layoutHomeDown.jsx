...
export default function LayoutHomeDown(props) {
  const {
    home,
    setHome,
    wish,
  ...
  return (
    <>
      <div className="navbar-fixed-down fixed left-0 right-0 flex bottom-0 items-center justify-around py-3 bg-white px-5 md:hidden">
        <div
          onClick={handleHome}
        ...
        >
          <svg
            ...
            width="20px"
            height="20px"
            className={'svg-nav' + (home ? ' fill-cyan-500' : '')}
          >
            <path d="M23.121,9.069,15.536,1.483a5.008,5.008,0,0,0-7.072,0L.879,9.069A2.978,2.978,0,0,0,0,11.19v9.817a3,3,0,0,0,3,3H21a3,3,0,0,0,3-3V11.19A2.978,2.978,0,0,0,23.121,9.069ZM15,22.007H9V18.073a3,3,0,0,1,6,0Zm7-1a1,1,0,0,1-1,1H17V18.073a5,5,0,0,0-10,0v3.934H3a1,1,0,0,1-1-1V11.19a1.008,1.008,0,0,1,.293-.707L9.878,2.9a3.008,3.008,0,0,1,4.244,0l7.585,7.586A1.008,1.008,0,0,1,22,11.19Z" />
          </svg>
          <p className={'p-nav' + (home ? ' text-cyan-500' : '')}>Home</p>
        </div>
        <div
        ...
        >
          <svg
            ...
            width="20px"
            height="20px"
            className={'svg-nav' + (wish ? ' fill-cyan-500' : '')}
          >
            <path d="M17.5,1.917a6.4,6.4,0,0,0-5.5,3.3,6.4,6.4,0,0,0-5.5-3.3A6.8,6.8,0,0,0,0,8.967c0,4.547,4.786,9.513,8.8,12.88a4.974,4.974,0,0,0,6.4,0C19.214,18.48,24,13.514,24,8.967A6.8,6.8,0,0,0,17.5,1.917Zm-3.585,18.4a2.973,2.973,0,0,1-3.83,0C4.947,16.006,2,11.87,2,8.967a4.8,4.8,0,0,1,4.5-5.05A4.8,4.8,0,0,1,11,8.967a1,1,0,0,0,2,0,4.8,4.8,0,0,1,4.5-5.05A4.8,4.8,0,0,1,22,8.967C22,11.87,19.053,16.006,13.915,20.313Z" />
          </svg>
          <p className={'p-nav' + (wish ? ' text-cyan-500' : '')}>Wislish</p>
        </div>
        <div
        ...
        >
          <svg
            ...
            width="20px"
            height="20px"
            className={'svg-nav' + (transac ? ' fill-cyan-500' : '')}
          >
          ...
          <p className={'p-nav' + (transac ? ' text-cyan-500' : '')}>
            Transaksi
          </p>
        </div>
        <div
        ...
        >
          <svg
            ...
            width="20px"
            height="20px"
            className={'svg-nav' + (profil ? ' fill-cyan-500' : '')}
          >
          ...
          <p className={'p-nav' + (profil ? ' text-cyan-500' : '')}>Profil</p>
        </div>
      </div>
    </>
  );
